...
BASE62 = BASE85[:62]
BASE62_LC = '0123456789abcdefghijklmnopqrstuvwxyz'
...
def int2str(num, radix=10, alphabet='0123456789abcdefghijklmnopqrstuvwxyz'):
    "helper function for quick base conversions from integers to strings"
    return NumConv(radix, alphabet).int2str(num)


def str2int(num, radix=10, alphabet='0123456789abcdefghijklmnopqrstuvwxyz'):
